...
tags:
  ...
  - Nerves
private: false
updated_at: '2024-02-09T10:13:16+09:00'
...
:::note info
[USBガジェットモード]に対応しているデバイスをご使用の場合は、USB ケーブルを電源供給とネットワークの両方に利用できます。[USB_On-The-Go]ポートに接続するよう注意してください。
:::
...
[USBガジェットモード]: http://www.linux-usb.org/gadget/
